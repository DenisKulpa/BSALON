...
import com.salonschedule.model.MyModel;
...
//        RequestDispatcher requestDispatcher = req.getRequestDispatcher("/guestmodepage.jsp");
//        requestDispatcher.forward(req,resp);
          resp.sendRedirect("/bsalon/guestmodepage");
    }
}
